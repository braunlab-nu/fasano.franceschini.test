...
`parallel` package and `mcapply()` the function for further details.
...
(B).](benchmark2.png){#fig:bmark width="75%" align="center"}
...
fasano.franceschini.test 1.0.0 package. **R** itself and all package
